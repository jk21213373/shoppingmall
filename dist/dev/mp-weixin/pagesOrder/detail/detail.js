...
if (!Array) {
  ...
  (_easycom_uni_countdown2 + _easycom_XRBFGuess2 + _easycom_uni_popup2)();
}
...
if (!Math) {
  (_easycom_uni_countdown + _easycom_XRBFGuess + PageSkeleton + _easycom_uni_popup)();
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return common_vendor.e({
        ...
        C: common_vendor.sr(guessRef, "2a0ba40d-1", {
          "k": "guessRef"
        }),
        ...
        S: common_vendor.sr(popup, "2a0ba40d-3", {
          "k": "popup"
        }),
        T: common_vendor.p({
          type: "bottom",
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/Users/Dell/Desktop/test/summer-fun-shopping/src/pagesOrder/detail/detail.vue"]]);
