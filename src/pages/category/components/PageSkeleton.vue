    ...
    <view class="viewport">
      ...
      <view class="categories">
        ...
        <scroll-view :scroll-y="true" class="secondary">
          <view is="components/XRBFSwiper" class="banner">
            <view class="carousel XRBFSwiper--carousel">
              <view class="indicator XRBFSwiper--indicator">
                <text class="dot XRBFSwiper--dot active XRBFSwiper--active"></text>
                <text class="dot XRBFSwiper--dot"></text>
                <text class="dot XRBFSwiper--dot"></text>
                <text class="dot XRBFSwiper--dot"></text>
                <text class="dot XRBFSwiper--dot"></text>
              </view>
...
/* #ifdef H5 || APP-PLUS */
/* 修复 H5 端骨架屏样式异常 */
@import '@/components/styles/XRBFSwiper.scss';
