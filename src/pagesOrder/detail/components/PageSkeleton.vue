    ...
    <scroll-view :scroll-y="true" class="viewport sk-transparent" id="scroller" :enable-back-to-top="true">
      ...
      <view class="shipment">
        <navigator class="logistics sk-image sk-pseudo sk-pseudo-circle" hover-class="none">
          <view class="message sk-transparent sk-text-14-2857-512 sk-text">商品到了小福家里，请签收</view>
        ...
        <view class="item">
          ...
          <navigator class="navigator" hover-class="none">
            ...
            <view class="meta">
              ...
              <view class="type sk-transparent sk-text-22-2222-110 sk-text">春秋款， 100%羊毛款：150x200cm，适合1.2米/1.35米床</view>
              <view class="price">
                <view class="actual">
                  <text class="symbol sk-transparent sk-opacity">¥</text>
      ...
      <view class="toolbar" style="padding-bottom: 34px">
        <view class="button primary sk-transparent sk-text-31-9444-411 sk-text" style="background-position-x: 50%">再次购买
        </view>
      </view>
    </scroll-view>
  </view>
